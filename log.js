...
export default {
    err: (...arg) => void     (['err', 'info', 'verbose', 'debug'].includes(config.logLevel) && stderr(chalk.grey(`[${chalk.red('Error')}]`), ...arg)),
    info: (...arg) => void    (['info', 'verbose', 'debug'].includes(config.logLevel) && stdout(chalk.grey(`[${chalk.blue('Info')}]`), ...arg)),
    verbose: (...arg) => void (['verbose', 'debug'].includes(config.logLevel) && stdout(chalk.grey(`[${chalk.yellow('Verbose')}]`), ...arg)),
    debug: (...arg) => void   (['debug'].includes(config.logLevel) && stdout(chalk.grey(`[${chalk.cyan('Debug')}]`), ...arg))
}